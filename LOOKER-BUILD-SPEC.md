...
| O11 | ~~Rename `Stephan Test` (ds29)~~ **DONE 2026-08-31** — renamed to `cost_by_product_market_pivot` | Apriil | Hygiene before Phase 2 |
| O12 | ~~Remove orphaned data sources~~ **DONE 2026-08-31** — 6 orphans removed. Report copy now has exactly 6 active sources: ds0 Master_CM360_Report, ds29 cost_by_product_market_pivot, ds34 t_daily_targets, ds36 CC last year, ds37 t_all_cost_raw, ds38 t_all_cost_brand_split. | Apriil | Hygiene before Phase 2 |
